...
)
{
    ...
    for (invaderIt; invaderIt != invaderEnd; ++invaderIt)
    {
            ...
            (*invaderIt).getTag() == "invader")
        {
            ...
            {
                if (
                    (*invaderIt).getEncompassingRectCollider().intersects(
...
)
{
    ...
    for (it3; it3 != end3; ++it3)
    {
        ...
        )
        {
            ...
            // current game object we might need
            FloatRect currentCollider =
                (*it3).getEncompassingRectCollider();
            ...
            // Handle the direction and descent of invaders
            if (currentTag == "invader")
            {
                ...
                {
                    // drop down arnd reverse has been set
...
void PhysicsEnginePlayMode::initilize(
