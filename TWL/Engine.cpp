...
Engine::Engine()
{
    ...
    if (!Shader::isAvailable())
    {
        ...
        // Or remove shader code
        m_Window.close();
    }
    else
    {
        // Load 2 shaders: vertex / fragment
        m_RippleShader.loadFromFile(
            "shaders/vertShader.vert", "shaders/rippleShader.frag");
    }
    ...
    m_TextureTiles =
        TextureHolder::GetTexture("graphics/tiles_sheet.png");
